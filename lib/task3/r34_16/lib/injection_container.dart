...
import 'package:r34_16/features/products/data/datasources/product_remote_datasource.dart';
import 'package:r34_16/features/products/data/repositories/product_repository_impl.dart';
import 'package:r34_16/features/products/domain/repositories/product_repository.dart';
import 'package:r34_16/features/products/domain/usecases/create_product.dart';
import 'package:r34_16/features/products/domain/usecases/delete_product.dart';
import 'package:r34_16/features/products/domain/usecases/get_all_products.dart';
import 'package:r34_16/features/products/domain/usecases/get_product.dart';
import 'package:r34_16/features/products/domain/usecases/update_product.dart';
import 'package:r34_16/features/products/presentation/services/product_console_service.dart';

import 'package:r34_16/features/users/data/datasources/user_remote_datasource.dart';
import 'package:r34_16/features/users/data/repositories/user_repository_impl.dart';
...
import 'package:r34_16/features/users/presentation/services/user_console_service.dart';

import 'package:r34_16/features/posts/data/datasources/post_remote_datasource.dart';
import 'package:r34_16/features/posts/data/repositories/post_repository_impl.dart';
...
import 'package:r34_16/features/posts/presentation/services/post_console_service.dart';
